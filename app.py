...
user_menu = st.sidebar.radio(
    'Select an option',
    ('Dashboard Overview', 'Medal Tally', 'Overall Analysis', 'Country-wise Analysis', 'Athlete-wise Analysis')
)
...
if user_menu == 'Dashboard Overview':
    ...
    # Display the dashboard in full width
...
# Medal Tally
    ...
    famous_sports = ['Basketball', 'Judo', 'Football', 'Tug-Of-War', 'Athletics',
                     ...
                     'Synchronised Swimming', 'Table Tennis', 'Baseball',
