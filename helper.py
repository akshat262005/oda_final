...
def most_successful(df, sport='Overall'):
    ...
    x = x.drop_duplicates('Name')[['Name', 'Medal_Count', 'Sport', 'region']]
...
def most_successful_country_wise(df, country):
    ...
    # Merge back with original DF to get Sport info
    x = top_athletes.head(10).merge(df, on='Name', how='left')
    x = x.drop_duplicates('Name')[['Name', 'Medals', 'Sport']]
